...
from .wrapper import AC_OK
from .wrapper import AC_CPU_Anime4K09, AC_CPU_ACNet, AC_OpenCL_Anime4K09, AC_OpenCL_ACNet, AC_Cuda_Anime4K09, AC_Cuda_ACNet

from .wrapper import AC_OTHER, AC_MP4V, AC_DXVA, AC_AVC1, AC_VP09, AC_HEVC, AC_AV01

from .wrapper import c_ac, ac_manager, ac_parameters
from .wrapper import ac_OpenCLAnime4K09Data, ac_OpenCLACNetData, ac_CUDAData, ac_managerData

from .wrapper import AC_ERROR_VIDEO_MODE_UNINIT
...
# Should I make it as @staticmethod of AC??
def get_c_parameters(parameters: Parameters) -> ctypes.Structure:
...
class AC:
	...
	def __init__(
		self,
		managerList: 'Optional[ManagerList]' = None,
		parameters: Parameters = Parameters(),
		type: int = ProcessorType.CPU_ACNet,
	) -> None:
	...
	def get_version() -> str:
		"""
		return the version of Anime4kCPP core and pya4k
		"""
		pya4k = "2.5.4"
		ac_version = c_ac.acGetVersion()
		core = str(ac_version.coreVersion, "utf-8")
		wrapper = str(ac_version.wrapperVersion, "utf-8")
	...
	def set_video_mode(self, flag: bool = True) -> None:
		err = c_ac.acSetVideoMode(self.ac_object, ctypes.c_int(flag))
		if err != AC_OK:
			raise ACError(err)

	def set_arguments(self, parameters: Parameters) -> None:
	...
	def load_image(self, src_path: str) -> None:
		"""
	...
	def save_image(self, dst_path: str) -> None:
		"""
		save image to disk
		"""
	...
	@staticmethod
	def check_GPU_support(GPGPU: int, pID: int = 0, dID: int = 0) -> 'Tuple[bool, str]':
		"""
	...
	def load_image_from_numpy(self, np_array: np.array, input_type: int = AC_INPUT_RGB) -> None:
		"""
	...
	@staticmethod
	def do_benchmark(processType: int, pID: int = 0, dID: int = 0) -> float:
		"""
...
class VideoProcessor(object):
	...
	def __init__(self, ac_object: AC = AC()) -> None:
	...
	def load_video(self, src_path: str) -> None:
		"""
	...
	def set_save_video_info(
		self, dst_path: str, codec: int = Codec.MP4V, fps: float = 0
	) -> None:
		"""
	...
	def process_with_progress(self) -> None:
		"""
	...
	def process_with_progress_callback(self, func: 'Callable') -> None:
		"""
	...
	def process_with_progress_time_callback(self, func: 'Callable') -> None:
		"""
		process video with callback function:
	...
	def pause_video_process(self) -> None:
		"""
	...
	def continue_video_process(self) -> None:
		"""
	...
	def stop_video_process(self) -> None:
		"""
