...
class AC:
	...
	def __get_c_parameters(self, parameters: Parameters) -> ctypes.Structure:
	...
	@staticmethod
	def get_GPU_list() -> 'Tuple[str, int, list]':
		"""
